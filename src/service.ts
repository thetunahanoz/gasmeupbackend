...
export class SuiService {
    ...
    constructor() {
        const rpcUrl = getFullnodeUrl(CONFIG.SUI_NETWORK as 'testnet' | 'mainnet' | 'devnet' | 'localnet');
     ...
     */
    public async sponsorAndExecuteTransaction(txBytesBase64: string, userSignatureBase64: string) {
        try {
